...
const pkdArray = [
  ...
  ["C", 10, "PKD 10.41.Z", "Produkcja olejów i pozostałych tłuszczów płynnych"],
  [
    "C",
    10,
    "PKD 10.42.Z",
  ...
  ["C", 11, "PKD 11.01.Z", "Destylowanie, rektyfikowanie i mieszanie alkoholi"],
  ...
  ["C", 17, "PKD 17.29.Z", "Produkcja pozostałych wyrobów z papieru i tektury"],
  ...
  ["C", 32, "PKD 32.13.Z", "Produkcja sztucznej biżuterii i wyrobów podobnych"],
  ...
  ["C", 33, "PKD 33.11.Z", "Naprawa i konserwacja metalowych wyrobów gotowych"],
  ...
  ["H", 49, "PKD 49.31.Z", "Transport lądowy pasażerski, miejski i podmiejski"],
  ...
  ["J", 61, "PKD 61.90.Z", "Działalność w zakresie pozostałej telekomunikacji"],
  ...
  ["L", 68, "PKD 68.10.Z", "Kupno i sprzedaż nieruchomości na własny rachunek"],
  [
    "L",
    68,
    "PKD 68.20.Z",
  ...
  ["N", 77, "PKD 77.32.Z", "Wynajem i dzierżawa maszyn i urządzeń budowlanych"],
  [
    "N",
    77,
    "PKD 77.33.Z",
  ...
  ["N", 77, "PKD 77.35.Z", "Wynajem i dzierżawa środków transportu lotniczego"],
  [
    "N",
    77,
    "PKD 77.39.Z",
  ...
  ["O", 84, "PKD 84.13.Z", "Kierowanie w zakresie efektywności gospodarowania"],
  ...
  ["R", 93, "PKD 93.21.Z", "Działalność wesołych miasteczek i parków rozrywki"],
